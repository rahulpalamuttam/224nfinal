...
flags.DEFINE_string('dataset', '../../data/BlogCatalog-dataset/data/', 'Dataset string.')  # 'cora', 'citeseer', 'pubmed'
...
flags.DEFINE_integer('max_degree', 4, 'Maximum Chebyshev polynomial degree.')
print(FLAGS.dataset)
# Load data
